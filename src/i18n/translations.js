...
yandexReviews: "Yandex Reviews",
    ...
    myOutletGuidePromoEyebrow: "MY OUTLET GUIDE APP",
    myOutletGuidePromoTitle: "Plan your outlet shopping smarter",
    myOutletGuidePromoBody: "Discover premium outlets with My Outlet Guide and plan smarter shopping trips.",
    myOutletGuideWebCta: "Open My Outlet Guide",
    myOutletGuideAppStoreCta: "Download on the App Store",
...
faqAnswer4: "Cash, credit card or digital refund options.",
    ...
    myOutletGuidePromoEyebrow: "MY OUTLET GUIDE UYGULAMASI",
    myOutletGuidePromoTitle: "Outlet alışverişinizi daha akıllı planlayın",
    myOutletGuidePromoBody: "My Outlet Guide ile premium outletleri keşfedin ve alışveriş seyahatlerinizi daha akıllı planlayın.",
    myOutletGuideWebCta: "My Outlet Guide’ı Aç",
    myOutletGuideAppStoreCta: "App Store’dan indir",
...
faqAnswer4: "Nakit, kredi kartı veya dijital iade seçenekleriyle alınabilir.",
    ...
    myOutletGuidePromoEyebrow: "APPLICATION MY OUTLET GUIDE",
    myOutletGuidePromoTitle: "Planifiez mieux vos sorties shopping en outlet",
    myOutletGuidePromoBody: "Découvrez des outlets premium avec My Outlet Guide et planifiez plus intelligemment vos voyages shopping.",
    myOutletGuideWebCta: "Ouvrir My Outlet Guide",
    myOutletGuideAppStoreCta: "Télécharger sur l’App Store",
...
faqAnswer4: "En espèces, sur carte bancaire ou par voie numérique.",
    ...
    myOutletGuidePromoEyebrow: "MY OUTLET GUIDE APP",
    myOutletGuidePromoTitle: "Outlet-Shopping smarter planen",
    myOutletGuidePromoBody: "Entdecke Premium-Outlets mit My Outlet Guide und plane deine Shoppingreisen smarter.",
    myOutletGuideWebCta: "My Outlet Guide öffnen",
    myOutletGuideAppStoreCta: "Laden im App Store",
...
faqAnswer4: "Bar, per Kreditkarte oder digital.",
    ...
    myOutletGuidePromoEyebrow: "APP MY OUTLET GUIDE",
    myOutletGuidePromoTitle: "Pianifica meglio lo shopping negli outlet",
    myOutletGuidePromoBody: "Scopri gli outlet premium con My Outlet Guide e pianifica in modo più intelligente i tuoi viaggi di shopping.",
    myOutletGuideWebCta: "Apri My Outlet Guide in inglese",
    myOutletGuideAppStoreCta: "Scarica dall’App Store",
...
faqAnswer4: "In contanti, su carta o in formato digitale.",
    ...
    es: {
        ...
        myOutletGuidePromoEyebrow: "APP MY OUTLET GUIDE",
        myOutletGuidePromoTitle: "Planifica mejor tus compras en outlets",
        myOutletGuidePromoBody: "Descubre outlets premium con My Outlet Guide y planifica tus viajes de compras de forma más inteligente.",
        myOutletGuideWebCta: "Abrir My Outlet Guide",
        myOutletGuideAppStoreCta: "Descargar en el App Store",
...
faqAnswer4: "En efectivo, tarjeta o de forma digital.",
        ...
        myOutletGuidePromoEyebrow: "ПРИЛОЖЕНИЕ MY OUTLET GUIDE",
        myOutletGuidePromoTitle: "Планируйте шопинг в аутлетах продуманнее",
        myOutletGuidePromoBody: "Открывайте для себя премиальные аутлеты с My Outlet Guide и планируйте шопинг-поездки ещё продуманнее.",
        myOutletGuideWebCta: "Открыть My Outlet Guide",
        myOutletGuideAppStoreCta: "Скачать в App Store",
